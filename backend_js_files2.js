// ===================================================================
// FILE: b/server.js - MAIN BACKEND SERVER
// ===================================================================
...
// ===================================================================
// FILE: b/services/vatCalculator.js - VAT CALCULATION SERVICE
// ===================================================================
...
// ===================================================================
// FILE: b/controllers/vatController.js - API CONTROLLER
// ===================================================================
...
// ===================================================================
// FILE: b/routes/vat.routes.js - API ROUTES
// ===================================================================
const express = require('express')
...
// ===================================================================
// FILE: b/.env - ENVIRONMENT VARIABLES
// ===================================================================
/*
...
// ===================================================================
// FILE: b/prisma/schema.prisma - DATABASE SCHEMA
// ===================================================================
/*
generator client {
...
model VatDeclaration {
  ...
  field40a  Decimal @default(0) @db.Decimal(15,2)
  field40b  Decimal @default(0) @db.Decimal(15,2)
  field41   Decimal @default(0) @db.Decimal(15,2)
  field43   Decimal @default(0) @db.Decimal(15,2)
  field81a  Decimal @default(0) @db.Decimal(15,2)
  field81b  Decimal @default(0) @db.Decimal(15,2)
  field89a  Decimal @default(0) @db.Decimal(15,2)
  field89b  Decimal @default(0) @db.Decimal(15,2)
  field67   Decimal @default(0) @db.Decimal(15,2)
  
  field4    Decimal @default(0) @db.Decimal(15,2)
  field8    Decimal @default(0) @db.Decimal(15,2)
  field66   Decimal @default(0) @db.Decimal(15,2)
  field61   Decimal @default(0) @db.Decimal(15,2)
  field62   Decimal @default(0) @db.Decimal(15,2)
  field83   Decimal @default(0) @db.Decimal(15,2)
  plannedProfit Decimal @default(0) @db.Decimal(15,2)
